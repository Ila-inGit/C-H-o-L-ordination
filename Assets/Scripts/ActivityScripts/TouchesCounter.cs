                ...
                case Constants.TOP_BOX:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.TOP_BOX, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "11", "-1", "11", -1, -1, "111", _topCounter));
                    }
                    break;
                case Constants.BOTTOM_BOX:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.BOTTOM_BOX, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "_00", "-1", "11", -1, -1, "100", _bottomCounter));
                    }
                    break;
                case Constants.LEFT_BOX:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.LEFT_BOX, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "10", "-1", "11", -1, -1, "110", _leftCounter));
                    }
                    break;
                ...
                case Constants.TOP_ANGLE:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.TOP_ANGLE, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "-1", "11", "_01", -1, -1, "_011", _topCounterOutside));
                    }
                    break;
                case Constants.BOTTOM_ANGLE:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.BOTTOM_ANGLE, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "-1", "_00", "_01", -1, -1, "_000", _bottomCounterOutside));
                    }
                    break;
                case Constants.LEFT_ANGLE:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.LEFT_ANGLE, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "-1", "10", "_01", -1, -1, "_010", _leftCounterOutside));
                    }
                    break;
                case Constants.RIGHT_ANGLE:
                    {
                        ...
                        DataCollector.Instance.addToFile(new MyData(Constants.RIGHT_ANGLE, ParseQRInfoManager.Instance.setUpInfo.patientID, "-1", gameObject.scene.name, "-1", "_01", "_01", -1, -1, "_001", _rightCounterOutside));
                    }
                    break;
            }
        }
